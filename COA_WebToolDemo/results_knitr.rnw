...
print(xtable(aoi_HabTerr[keeps], caption = 'Habitat type within area of interest'), 
      latex.environments="flushleft", caption.placement="top", floating=FALSE) 
@

<<label=LongTable, echo=FALSE, results='asis'>>=
print(
  xtable(aoi_sgcn_results, caption = 'Occurrence probability of species of greatest conservation need within the chosen area of interest'), 
