...
\noindent\normalsize \\
The following table shows the distribution of habitats across the overlapping planning units. Habitats (i.e. ecological systems) are grouped by the macrogroup. For more information habitats, please see the 2015 Pennsylvania Wildlife Action Plan.\\
...
@
\noindent\normalsize 
Additionally, the following SGCN are noted as having a low probability of occurence within the AOI: \Sexpr{aoi_sgcnXpu_LowOccProb}. Habitat may be present for them, but a additional survey work should be done to confirm their presence.
\\
