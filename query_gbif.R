...
#splist <- c("Piranga olivacea","Quercus alba","Ambystoma jeffersonianum","Aneides aeneus","Clonophis kirtlandii","Kinosternon subrubrum","Accipiter gentilis","Glyptemys insculpta","madeuptestname") # use for testing!
...
dat <- occ_search(
                  ...
                  year='1990,2016',
                  fields=c('name','datasetKey','key','decimalLatitude','decimalLongitude','country','basisOfRecord','coordinateAccuracy','year','month','day')
                 )
